...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
  ...
  <symbol id="bi bi-shop" viewBox="0 0 16 16">
...
<div class="container-fluid">
  <div class="row">
    <!-- 사이드바 시작 -->
    <div id="uniqueSidebar" class="col-md-3 d-flex flex-column flex-shrink-0 p-3 text-bg-light" style="width: 300px; height:300px; position: sticky; top: 0;">
     <a href="/" class="d-flex align-items-center mb-md-0 me-md-auto text-black text-decoration-none">
        ...
        <span class="fs-4">사장님<br>커뮤니티</span>
      </a>
      ...
      <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li>
          <button id="boardBtn" class="btn nav-link text-black" style="font:bold;">
